    ...
    var LS = function LS (customSettings) {
        ...
        promise = new Promise(function (resolve, reject) {
            ...
            if (settings.endpoint) {
                ...
                reject(new Error('init error: Missing parameter, or missing endpoint property'));
            }
        });
        ...
        // private storage that does not have public functionality
        //
        // behavioural function: add instance to instances container
        ...
        // behavioural function: remove instance from instances container
        // and remove instances local storage if container is empty
